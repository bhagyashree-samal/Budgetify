...
import EmojiPickerPopup from '../income/EmojiPickerPopup';
...
const AddExpenseForm = ({onAddExpense}) => {
  ...
  return (
    <div>
        ...
        <Input value={expense.category} onChange={({target})=>handleChange("category",target.value)} label="Expense Category" placeholder="Rent, Groceries etc" type="text"/>
